...
def api_question_status(test_id):
    ...
    if db_file:
        ...
        if os.path.exists(db_path):
            ...
            # 🔥 CREATE TABLE IF NOT EXISTS (your missing piece!)
            conn.execute('''
        ...
        # 🔥 CREATE TABLE for session DB too
        conn.execute('''CREATE TABLE IF NOT EXISTS question_status (...)''')  # Same CREATE above
    ...
    try:
        ...
        # 🔥 GET: Flutter expects this exact format
        test = conn.execute('SELECT * FROM test_info WHERE id = ?', (test_id,)).fetchone()
        questions = conn.execute(
        ...
        # MARKED QUESTIONS (Flutter expects)
        ...
        # SKIPPED QUESTIONS (Flutter expects)
